      PROGRAM EXAMPLE2B
C
C** Open DASTCOM5, return only DASTCOM3 information for comets & asteroids      
C
...
C    &      SBNAM
C
C     DATA         IR8ORD   /            ! Request DASTCOM3 asteroid num. fields
C    &              201,801,802,803,804,805,806,807,808,810,
C    &              811,809,432,433,401,402,439,431,438, 123*0  /
C     DATA         ICHORD   /            ! Request DASTCOM3 asteroid char fields
C    &               14,1,13,11,4,6,7,8,3,5*0 /
C     DATA         NR8,NCH  /  19, 9   / ! Max. # num. & char. fields to get
C
...
C    &              201,801,802,803,804,805,806,807,808,810,
C    &              811,809,432,433,408,409,403,404,151, 123*0  /
C     DATA         ICHORD   /            ! Request DASTCOM3 comet char fields
C    &               14,1,13,11,6,9,10,3,6*0 /
C
C  So COMBINE them in a single list that can support DASTCOM3 data from
C  any record.
C
      DATA         DBNAM    /
     ...
     &               9,10, 3*0 /      ! stick comet unique data at end
